...
func main() {
	if len(os.Args) < 2 {
		...
		fmt.Fprintln(os.Stderr, "  package install <pkg> --agent <name> [--save]")
		fmt.Fprintln(os.Stderr, "  package remove <pkg> [--agent <name>] [--save]")
		fmt.Fprintln(os.Stderr, "  package list [--agent <name>]")
		fmt.Fprintln(os.Stderr, "  protocol check <id> [--exempt <check> --reason <why>]")
		fmt.Fprintln(os.Stderr, "  protocol list                     List protocol contracts")
